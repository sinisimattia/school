...
<div class="welcome">
    <div class="hero is-white is-fullheight">
        ...
        <div class="hero-body media is-vcentered container">
            <div class="media-left has-text-left">
                <div class="has-text-black">
                    <h1 class="title is-1">School<span class="has-text-primary">++</span><span class="subtitle is-3">.space</span></h1>
            ...
            <div class="media-right has-text-right is-hidden-touch">
